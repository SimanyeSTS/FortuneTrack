<template>
  <div class="admin-retail-modal" @click.self="$emit('close')">
...
export default {
  ...
  try {
    ...
    await this.$store.dispatch('createRetail', retailData);
    ...
    Swal.fire({
      icon: 'error',
      title: 'Error!',
      text: 'There was an error adding the retail prediction. Please try again later.',
    });
  }
},
    resetForm() {
