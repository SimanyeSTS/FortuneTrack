    ...
    <div class="admin-technology-modal">
      <div class="admin-technology-modal-content">
        ...
        <div class="modal-scroll-container">
          <form @submit.prevent="createTechnology">
...
export default {
  props: {
    showAddNewTechnologyModal: Boolean,
    isLoading: Boolean
  },
  data() {
    return {
...
methods: {
  ...
  console.log('createTechnology called'); // Log to confirm the method is called
  if (!this.isFormValid) {
    ...
    return;
      ...
      try {
        ...
        await this.$store.dispatch('createTechnology', technologyData);
        ...
        console.error('Error adding technology prediction:', error);
      }
    },
    resetForm() {
      this.Symbol = '';
